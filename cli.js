...
`);
  ...
  async function consensus() {
    ...
    const networkSettingsFooter = ['Consensus'].concat(Array(networkSettingsHeader.length).fill(consensusCell)).concat([function (cell, columnIndex, rowIndex, rowData) { return ''; }]);
    s += '\n\n  [Public Settings]'
